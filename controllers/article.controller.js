const {  readArticleById, updateArticle, readArticlesByQuery, addArticle, removeArticle} = require("../models/article.model");
...
module.exports = { getArticles, getArticleById, patchArticle, postArticle , deleteArticle};
